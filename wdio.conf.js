...
exports.config = {
    ...
    //
    specs: [
        'features/login.feature' //'./features/**/*.feature' features\login.feature
        // './sampletest.js'
    ],
    // Patterns to exclude.
    exclude: [
    ...
    baseUrl: 'E:/VS_Code_Project/TestSolution/LoginApp/index.html',
    ...
    OnCOmplete: function(exitCode, config, capabilities, results) {
        try {
            generate ({
                jsonDir: 'report/',
                reportPath: 'report/multicucumber/'
            })
        } catch (ex) {
            console.log('Oncomplete : error generating multi cucumber report');
        }
    },
    /**
